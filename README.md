...
# Key Findings
- Identified active host in isolated network
- Detected open TCP port and exposed services
- Performed service enumeration using Nmap (-sV)
- Simulated network service using Netcat
